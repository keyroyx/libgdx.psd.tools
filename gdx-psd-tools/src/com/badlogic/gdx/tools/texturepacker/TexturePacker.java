...
public class TexturePacker {
	...
	public List<Page> packPages () {
		List<Page> pageList = new ArrayList<TexturePacker.Page>();
	...
	public List<Rect> pack () {
		List<Rect> rects = new ArrayList<TexturePacker.Rect>();
		List<Page> pageList = packPages();
	...
	static public class Settings {
		...
		public boolean edgePadding = false;
